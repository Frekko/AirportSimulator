...
//        private static int iter = 0;
        ...
        public static Common.Plane GeneratePlane(int passengerCount)
        {
            ...
            URL = String.Format("{0}/GeneratePassengers?id={1}&count={2}", ServiceStrings.Passenger, planeId,
                passengerCount);
            string passengerString = CommonUtil.MakeRequest(URL);
            ...
            Common.Plane plane = new Common.Plane(planeId, registrationList.Passengers, registrationList.CargoCount,
                fuelCount);
            return plane;
        }
